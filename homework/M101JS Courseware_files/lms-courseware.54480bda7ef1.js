...
(function() {
  ...
  this.Histogram = (function() {
    ...
    Histogram.prototype.calculate = function() {
      var count, log_count, score, _i, _len, _ref, _ref2, _results;
      _ref = this.rawData;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        _ref2 = _ref[_i], score = _ref2[0], count = _ref2[1];
...
(function() {
  ...
  this.Navigation = (function() {
    ...
    function Navigation() {
      var active, collapsible;
      if ($('#accordion').length) {
        active = $('#accordion ul:has(li.active)').index('#accordion ul');
        if (active < 0) active = $('#accordion h3.active').index('#accordion h3');
        if (active < 0) active = 0;
        collapsible = false;
        if ($('#accordion ul').length > 1) collapsible = true;
